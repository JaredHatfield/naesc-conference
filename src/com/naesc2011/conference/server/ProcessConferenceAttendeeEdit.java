...
public class ProcessConferenceAttendeeEdit extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (p.IsUserLoggedIn()) {
            ...
            ConferenceAttendee ca = ConferenceAttendee.GetAttendee(pm, id);

            // Update all of the parameters that were passed in
